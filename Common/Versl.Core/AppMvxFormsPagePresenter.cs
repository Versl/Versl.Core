...
namespace Versl.Core
{
    public class AppMvxFormsPagePresenter : MvxFormsPagePresenter
    {        
        #region Public Constructors

        public AppMvxFormsPagePresenter(IMvxFormsViewPresenter platformPresenter) : base(platformPresenter)
        {
        }
            ...
            MvxViewModelRequest request)
        {
            ...
            else
            {
                ...
                if (attribute.WrapInNavigationPage)
                {
                    ...
                    {
                        var vm = ((MvxViewModelInstanceRequest)request).ViewModelInstance as IViewModelBase;

                        tp.Title = page.Title;
                        tp.IconImageSource = vm.PageIconImageSource;
                    });
                }
                // END OF: FIX
